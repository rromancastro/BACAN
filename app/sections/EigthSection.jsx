        ...
        <section id="eigthSection">
            <div id="eigthSectionContent">
                ...
                <div id="eightSectionDiv2">
                    <div>
                        <h3>AYUDA</h3>
                        <p>¿Alguna duda sobre el juego? Ponte en contacto con nosotros a travez de<br />nuestras redes. No dejes que tus colegas hagan trampas, conocemos las<br />reglas y podemos ayudarte.</p>
                    </div>
