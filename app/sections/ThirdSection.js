    ...
    return (
        ...
        <div id="thirdSectionCardsContainer">
          <div onMouseOver={() => setCard1Zoom(1.5)} onMouseLeave={() => {setCard1Zoom(1)}} style={{gap: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gridArea: 'area1', backgroundColor: '#F8CD78', borderRadius: '16px', padding: '24px'}}>
            ...
            <p style={{fontWeight: '400', fontSize: '12px', color: '#564421'}}>Si eres una tortuga, ¡despierta! Aquí no te esperan para cruzar la calle.</p>
          ...
          <div onMouseOver={() => setAnimarCard3(true)} onMouseOut={() => setAnimarCard3(false)} style={{gap: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', gridArea: 'area3', backgroundColor: '#7ABDEC', borderRadius: '16px', padding: '24px'}}>
            ...
            <p style={{fontWeight: '400', fontSize: '12px', color: '#225274'}}>No olvides tus cartas, porque no podrás verlas así de fácil.</p>
          </div>
          ...
          <div onMouseOver={() => setAnimarCard4(true)} onMouseLeave={() => setAnimarCard4(false)} style={{gap: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gridArea: 'area4', backgroundColor: '#EF91CD', borderRadius: '16px'}}>
            ...
            <Image src="/thirdSectionImages/card4flecha1.png" alt="mazo" width={12} height={12} style={{transition: '.5s', transform: animarCard4 ? 'rotate(-160deg)' : 'rotate(20deg)',position: 'absolute', width: '12px', height: '12px', objectFit: 'contain', bottom: '25.3%', left: '26%',borderRadius: '16px', objectPosition: 'top'}}/>
            <Image src="/thirdSectionImages/card4flecha2.png" alt="mazo" width={12} height={12} style={{transition: '.5s', transform: animarCard4 ? 'rotate(-220deg)' : 'rotate(-35deg)',position: 'absolute', width: '12px', height: '12px', objectFit: 'contain', bottom: '29.8%', left: '64.5%',borderRadius: '16px', objectPosition: 'top'}}/>
          </div>
          ...
          <div onMouseOver={() => setAnimarCard5(true)} onMouseLeave={()=>setAnimarCard5(false)} style={{gap: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', gridArea: 'area5', overflow: 'hidden',backgroundColor: '#B1D18D', borderRadius: '16px', padding: '24px'}}>
            ...
            <p style={{fontWeight: '400', fontSize: '12px', color: '#2B440E'}}>Arma tu jugada,
<br />las cartas te<br />acompañan.</p>
          ...
          <div onMouseOver={handleAnimCard6} onMouseLeave={handleClearCard6} style={{gap: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', gridArea: 'area6', backgroundColor: '#F8CD78', borderRadius: '16px', padding: '24px'}}>
            ...
            <p style={{fontWeight: '400', fontSize: '12px', color: '#564421'}}>Las cartas están echadas, puede que te toque algo bueno. No lo desperdicies.</p>
          </div>
        </div>
      </section>
    )
