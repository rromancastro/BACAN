        ...
        <section id="thirdSectionMobile">
            <div id="thirdSectionMobileSticky">
                ...
                <div id="thirdSectionMobileCarsContainer">
                    ...
                    <div className="thirdSectionMobileCard" style={{backgroundColor: '#FF8283', top: interpolar(16, 26, 460, 0) }}>
                    ...
                    <div className="thirdSectionMobileCard" style={{backgroundColor: '#7ABDEC', top: interpolar(26, 36, 490, 0)}}>
                    ...
                    <div className="thirdSectionMobileCard" style={{backgroundColor: '#EF91CD', top: interpolar(36, 46, 520, 0)}}>
                    ...
                    <div className="thirdSectionMobileCard" style={{backgroundColor: '#B1D18D', top: interpolar(46, 56, 550, 0)}}>
                        ...
                        <div style={{position: 'absolute', display: 'flex', rotate: '-15deg', left: '30px'}}>
                          <div style={{transition: '.5s', display: 'flex', flexDirection: 'column', transform: `translateY(${interpolar(46, 56, 290, 130)}px)` }}>
                          ...
                          <div style={{transition: '.5s', display: 'flex', flexDirection: 'column', transform: `translateY(${interpolar(46, 56, 790, 90)}px)` }}>
                    ...
                    <div className="thirdSectionMobileCard" style={{transition: '.5s', backgroundColor: '#F8CD78', top: interpolar(56, 66, 580, 0)}}>
